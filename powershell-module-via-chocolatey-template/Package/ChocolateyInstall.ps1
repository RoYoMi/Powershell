...
# command to create the Chocolatey package
#   choco pack X:\gitlab\dw-endpoint\Modules\powershell-module-via-chocolatey-template\Chocolatey\Package.nuspec --out \\nm.nmfco.com\dfs01\appls\sd\Chocolatey
...
Write-host "`nTo test the install you can issue the following command"
write-host "`n     Get-SampleQuote`n" -ForegroundColor Cyan
